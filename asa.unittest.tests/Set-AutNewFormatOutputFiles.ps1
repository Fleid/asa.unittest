...
Describe "Set-AutNewFormatOutputFiles paramater installPath" {
    InModuleScope $moduleName {
        ...
        It "doesn't create a folder if it exists" {
            Set-AutNewFormatOutputFiles -installPath $t_installPath |
...
Describe "Set-AutNewFormatOutputFiles behavior folder structure" {
    InModuleScope $moduleName {
...
Describe "Set-AutNewFormatOutputFiles behavior dependencies" {
        InModuleScope $moduleName {
...
Describe "Set-AutNewFormatOutputFiles behavior gitignore" {
    InModuleScope $moduleName {
